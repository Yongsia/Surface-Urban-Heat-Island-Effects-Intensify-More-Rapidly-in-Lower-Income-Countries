...
df = raster('/mnt/work/YY/year_night/pvalue.tif')
df_s = raster('/mnt/work/YY/year_night/slope.tif')
...
write.csv(is.inp,file = "/mnt/work/YY/year_night/inp.csv")
write.csv(is.inp,file = "/mnt/work/YY/year_night/ins.csv")

ad.mergep = cbind(is.inp, p.hit,row.names = NULL)
write.csv(ad.mergep,file = "/mnt/work/YY/year_night/YN_p.csv")

ad.merges = cbind(is.ins, slope.hit,row.names = NULL)
write.csv(ad.merges,file = "/mnt/work/YY/year_night/YN_s.csv")
...
ad.mergep = ad.mergep[,c(7,10,16,19,25,55,56,57,58)]
ad.merges = ad.merges[,c(55,56,57)]
...
write.csv(last.df,file = "/mnt/work/YY/year_night/YN.csv")




a = read.csv("/mnt/work/YY/year_night/YN.csv")  
...
write.csv(d,file = "/mnt/work/YY/year_night/YN_per.csv")
