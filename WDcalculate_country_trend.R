...
df = raster('/mnt/work/YY/winter/day/pvalue.tif')
df_s = raster('/mnt/work/YY/winter/day/slope.tif')
...
write.csv(ad.mergep,file = "/mnt/work/YY/winter/day/WD_p.csv")

ad.merges = cbind(is.ins, slope.hit,row.names = NULL)
write.csv(ad.merges,file = "/mnt/work/YY/winter/day/WD_s.csv")
