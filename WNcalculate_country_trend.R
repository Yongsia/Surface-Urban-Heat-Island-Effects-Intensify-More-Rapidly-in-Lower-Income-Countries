...
df = raster('/mnt/work/YY/winter/night/pvalue.tif')
df_s = raster('/mnt/work/YY/winter/night/slope.tif')
...
write.csv(ad.mergep,file = "/mnt/work/YY/winter/night/WN_p.csv")

ad.merges = cbind(is.ins, slope.hit,row.names = NULL)
write.csv(ad.merges,file = "/mnt/work/YY/winter/night/WN_s.csv")
